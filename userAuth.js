        ...
        if (data) {
           ...
           console.log(id)
            ...
            var mailOptions = {
                ...
                html: `<h4>To reset your password please click on this <a href="https://cakes-site.netlify.app/resetpassword/${token}">link</a></h4>`
            }
    ...
    try {
        ...
        if (!data) {
            ...
            var mailOptions = {
                ...
                <a href="https://cakes-site.netlify.app/confirm/${confirmationcode}"> Click here</a>`
            }
